...
export default defineSchema({
  ...
  certificateTemplates: defineTable({
    ...
    thirdLogoUrl: v.optional(v.string()),
    thirdLogoStorageId: v.optional(v.id("_storage")),
    logoScale: v.optional(v.number()),
    secondLogoScale: v.optional(v.number()),
    thirdLogoScale: v.optional(v.number()),
    signatureLine: v.optional(v.string()),
    signature2Line: v.optional(v.string()),
    signature3Line: v.optional(v.string()),
    ...
    signature3ImageUrl: v.optional(v.string()),
    signature3ImageStorageId: v.optional(v.id("_storage")),
